...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/buttonFilter'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/buttonAtoZ'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/buttonFilter'))

WebUI.click(findTestObject('Page_Swag Labs/buttonLowtoHigh'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Test.allTheThings() T-Shirt (Red)This c_74cf00'))
